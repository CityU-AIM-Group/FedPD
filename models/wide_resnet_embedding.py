...
if __name__ == '__main__':
    net=Wide_ResNet(28, 10, 50)
    y = net(Variable(torch.randn(1,3,32,32)))

    flops, params = profile(net, inputs=(Variable(torch.randn(1,3,32,32)), ),verbose=True)
    print("%s | %.2f | %.2f" % ('net', params / (1000 ** 2), flops / (1000 ** 3)))
